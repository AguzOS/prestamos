...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        removeLabel: 'Quitar',
        removeTitle: 'Quitar archivos seleccionados" name="quitar" id="quitar',
        ...
        fileActionSettings: {
            ...
            zoomTitle: 'Ver detalles" style="display:none" id="zoom',
            dragTitle: 'Mover / Arreglar de nuevo" style="display:none"',
